...
import 'package:kensington/pages/savesearchpages/EditSearch/EditAdvanceSearch.dart';
import 'package:kensington/pages/savesearchpages/EditSearch/EditAdvanceSearchNew.dart';
...
class EditNormalSearch extends StatefulWidget {
  String save_id,counryname,regionname,loactionname,propertyname,counryid,regionnid,propertyid,lookingforid,lookingforname,plotsizefrom,plotsizto,livingfrom,livingto,roomfrom,roomto,bedfrom,bedto,batfrom,bathto,pricefrom,priceto,terrace,aircondition,swiming,seaview,araename,areaid;
  EditNormalSearch({
    Key key,this.save_id,this.counryname,this.regionname,this.loactionname,this.propertyname,this.counryid,this.regionnid,this.propertyid,this.lookingforid,this.lookingforname,this.plotsizefrom,this.plotsizto,this.livingfrom,this.livingto,this.batfrom,this.bathto,this.bedto,this.bedfrom,this.seaview,this.aircondition,this.pricefrom,this.priceto,this.roomfrom,this.roomto,this.terrace,this.swiming,this.araename,this.areaid
  }) : super(key: key);
...
class _HomePageState extends State<EditNormalSearch> {
  ...
  String selectedlookingforname="",selectedcountrynamelang;
...
if(countrylist!=null){
  ...
  void _savesearch(BuildContext context) {
   ...
   // print('"country${selectedStateID}plotfrom${selectdregionId}plotfrom${selectlocation}${selectedlokkingfor}${selectedpropertid}${selectregion}${widget.save_id}${selectproperty}${ widget.lookingforname==null?"0":widget.lookingforname}${ selectedlookingforname}');
    Provider.of<LoginProvider>(context, listen: false)
        ...
        widget.plotsizefrom=="All"?"All": widget.plotsizefrom,
        widget.plotsizto,
        widget.livingfrom=="All"?"All": widget.livingfrom,
        widget.livingto,
        widget.roomfrom=="All"?"All": widget.roomfrom,
        widget.roomto,
        widget.bedfrom=="All"?"All": widget.bedfrom,
      widget.bedto,
        widget.batfrom=="All"?"All": widget.batfrom,
       widget.bathto,
        widget.terrace,
        widget.pricefrom=="All"?"All": widget.pricefrom,
        widget.priceto,
        ...
        widget.swiming,
        widget.save_id,
        selectedlookingforname==null?"All":selectedlookingforname,
     selectproperty==null?"All":selectproperty,
        selectarea=="0"?"All":selectarea,
  ...
  void initState() {
    ...
    //main();
    //print("country${widget.counryid.toString()+widget.counryname.toString()}region${widget.regionname.toString()+widget.regionnid.toString()}loca${widget.loactionname}looking${widget.lookingforid}prop${widget.propertyname}");

    if(country_list!=null){
      country_list.clear();
      selectedStateID=widget.counryid.toString();selectdregionId=widget.regionnid.toString();selectedlokkingfor=widget.lookingforid;
      selectcountry = widget.counryname.toString();

      selectedpropertid=widget.propertyid;
      selectregion=widget.regionname.toString();
      selectlocation=widget.loactionname.toString();
      selectlookingfor=widget.lookingforname;
  selectedlookingforname=widget.lookingforname;
      selectproperty=widget.propertyname;
      selectedareaid=widget.areaid;
selectarea=widget.araename;

//print("${selectedStateID+selectdregionId+selectedlokkingfor+selectcountry+selectedpropertid+selectregion+selectlocation+selectedlookingforname+selectproperty+selectarea}");
      getcountry();


      if(selectregion=="Mallorca"){
        _areadropdown=true;
if(widget.araename!=null){
  selectarea=widget.araename;
  if (selectdregionId == '-1') {
  } else {
    region_list.clear();
    ...
    get_property();
    print("lissss${loactionnamemultiple.length}");
    if(loactionnamemultiple!=null){
      //loactionnamemultiple.clear();
      print("prgg");
      getlocationforarea(selectdregionId);
    }
      ...
      getlocationforarea(selectdregionId);
        ...
        _areadropdown=false;
       // print("regionid${selectdregionId}");
        if (selectdregionId == '-1') {
        } else {
          region_list.clear();
          citymodel_list.clear();
  ...
  void dropDownStateSelected(String newValueSelected, int index) {
    setState(() {
      ...
      // selectregion=null;selectlocation=null;selectproperty=null;
  ...
  void dropDownLookingSelected(String newValueSelected, int index) {
    setState(() {
      ...
      selectedlookingforname=selectlookingfor;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton(
                                isExpanded: true,
                                value: selectcountry,
                                hint:Text(selectcountry,style: GoogleFonts.ptSerif(
                        ...
                        Container(
                          ...
                          DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton(
                                isExpanded: true,
                                value: selectregion==null?translate('landing_screen.all'):selectregion,
                                hint:Text(selectregion==null?translate('landing_screen.all'):selectregion,style: GoogleFonts.ptSerif(
                                    color: ColorConstant.kGreenColor,fontSize: 18
                                ),),
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              ...
                              child: DropdownButton(
                                ...
                                hint:Text(selectlocation==null?translate('landing_screen.all'):location_name_multiple.length>2?"${location_name_multiple.length.toString()} selected":selectlocation.isEmpty?translate('landing_screen.all'):selectlocation,style: GoogleFonts.ptSerif(
                                    color: ColorConstant.kGreenColor,fontSize: 18
                                ),),
                                items: [],
                                underline: SizedBox(),
                        ...
                        Container(
                          ...
                          DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton(
                                ...
                                hint:Text(selectlookingfor==null?translate('landing_screen.all'):selectlookingfor=="0"?translate('landing_screen.all'):selectlookingfor,style: GoogleFonts.ptSerif(
                                    color: ColorConstant.kGreenColor,fontSize: 18
                                ),),
                          ...
                          child: Container(
                            ...
                            DropdownButtonHideUnderline(
                              ...
                              child: DropdownButton(
                                ...
                                hint:Text(selectproperty==null?translate('landing_screen.all'):property_name_multiple.length>2?"${property_name_multiple.length.toString()+" "+translate('landing_screen.selected_landing')}":selectproperty.isEmpty?translate('landing_screen.all'):selectproperty=="0"?translate('landing_screen.all'):selectproperty,style: GoogleFonts.ptSerif(
                                    color: ColorConstant.kGreenColor,fontSize: 18
                                ),),
                                items:[],
                                underline: SizedBox(),
                        ...
                        GestureDetector(
                            onTap: (){
                              ...
                              Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => EditAdvanceSearchNew(  countryid:selectedStateID=="1"?"1":selectedStateID,region_name:selectdregionId=="-1"?"0":selectdregionId,location_name:selectlocation==null?"0":selectlocation,looking_for:selectedlokkingfor=="-1"?"0":selectedlokkingfor,property_type:selectedpropertid=="-1"?"0":selectedpropertid.isEmpty?"0":selectedpropertid,region_name_real:selectregion==null?"All":selectregion,save_id: widget.save_id,propertyname: selectproperty,lookingforid: selectedlookingforname,plotsizefrom:widget.plotsizefrom,plotsizto:widget.plotsizto,livingfrom:widget.livingfrom,livingto:widget.livingto,roomfrom:widget.roomfrom,roomto:widget.roomto,bedfrom:widget.bedfrom,bedto:widget.bedto,batfrom:widget.batfrom,bathto:widget.bathto,pricefrom:widget.pricefrom,priceto:widget.priceto,terrace:widget.terrace,aircondition:widget.aircondition,swiming:widget.swiming,seaview:widget.seaview,areaname:widget.araename,selectedareaid:selectedareaid,)));
