...
class AdvaceSearchForLandingNewScreen extends StatefulWidget {
  String countryid,region_name,location_name,looking_for,property_type,region_name_real,lookingforname,propertytypename,araename,selectedareaid;
  AdvaceSearchForLandingNewScreen({
    Key key,this.countryid,this.region_name,this.location_name,this.looking_for,this.property_type,this.region_name_real,this.propertytypename,this.lookingforname,this.araename,this.selectedareaid
  }) : super(key: key);
...
class _AdvaceSearchState extends State<AdvaceSearchForLandingNewScreen> {
  ...
  void _savesearch(BuildContext context) {
    //print('"country${widget.looking_for.toString()}plotfrom${sizetext}plotfrom${livingroomtext}${roomtext}${bedroomtext}${bathroomtext}${priceroomtext}${widget.propertytypename}${ widget.lookingforname==null?"0":widget.lookingforname}${ widget.propertytypename==null?"0":widget.propertytypename}');
    Provider.of<LoginProvider>(context, listen: false)
      ...
      sizetext.isEmpty?"All":sizetext.contains(translate('advance_search.from'))?sizetext.replaceAll(new RegExp(r'[^0-9]'),''):sizetext.contains(translate('advance_search.select_text'))?"All":sizetext.replaceAll(new RegExp(r'[^0-9]'),''),
      sizetext1.isEmpty?maxplot.toString():sizetext1.contains(translate('advance_search.select_text'))?maxplot.toString():sizetext1.replaceAll(new RegExp(r'[^0-9]'),''),
      livingroomtext.isEmpty?"All":livingroomtext.contains(translate(translate('advance_search.from')))?livingroomtext.replaceAll(new RegExp(r'[^0-9]'),''):livingroomtext.contains(translate('advance_search.select_text'))?"All":livingroomtext.replaceAll(new RegExp(r'[^0-9]'),''),
      livingroomtext1.isEmpty?maxliving.toString():livingroomtext1.contains(translate('advance_search.select_text'))?maxliving.toString():livingroomtext1.replaceAll(new RegExp(r'[^0-9]'),''),
      roomtext.isEmpty?"All":roomtext.contains(translate(translate('advance_search.from')))?roomtext.replaceAll(new RegExp(r'[^0-9]'),''):roomtext.contains(translate('advance_search.select_text'))?"All":roomtext.replaceAll(new RegExp(r'[^0-9]'),''),
      roomtext1.isEmpty?maxroom.toString():roomtext1.contains(translate('advance_search.select_text'))?maxroom.toString():roomtext1.replaceAll(new RegExp(r'[^0-9]'),''),
      bedroomtext.isEmpty?"All":bedroomtext.contains(translate('advance_search.from'))?bedroomtext.replaceAll(new RegExp(r'[^0-9]'),''):bedroomtext.contains(translate('advance_search.select_text'))?"All":bedroomtext.replaceAll(new RegExp(r'[^0-9]'),''),
      bedroomtext1.isEmpty?bedroom.toString():bedroomtext1.contains(translate('advance_search.select_text'))?bedroom.toString():bedroomtext1.replaceAll(new RegExp(r'[^0-9]'),''),
      bathroomtext.isEmpty?"All":bathroomtext.contains(translate(translate('advance_search.from')))?bathroomtext.replaceAll(new RegExp(r'[^0-9]'),''):bathroomtext.contains(translate('advance_search.select_text'))?"All":bathroomtext.replaceAll(new RegExp(r'[^0-9]'),''),
      bathroomtext1.isEmpty?maxbathroom.toString():bathroomtext1.contains(translate('advance_search.select_text'))?maxbathroom.toString():bathroomtext1.replaceAll(new RegExp(r'[^0-9]'),''),
      _valuetarrace?"1":"0",
      priceroomtext.isEmpty?"All":priceroomtext.contains(translate(translate('advance_search.from')))?priceroomtext.replaceAll(new RegExp(r'[^0-9.]'),''):priceroomtext.contains(translate('advance_search.select_text'))?"All":priceroomtext.replaceAll(new RegExp(r'[^0-9.]'),''),
      priceroomtext1.isEmpty?maxprice.toString():priceroomtext1.contains(translate('advance_search.select_text'))?maxprice.toString():priceroomtext1.replaceAll(new RegExp(r'[^0-9.]'),''),
        "1",
        widget.region_name_real==null?"0":widget.region_name_real,
        _value1?"1":"0",
        _value2?"1":"0",
        _value3?"1":"0",
        widget.lookingforname==null?"0":widget.lookingforname,
        widget.propertytypename==null?"0":widget.propertytypename,
widget.araename==null?"":widget.araename,
