...
class SaveAdvanceSearch extends StatefulWidget {
  String countryid,region_name,location_name,looking_for,property_type,region_name_real,lookingforname,propertytypename;
  SaveAdvanceSearch({
    Key key,this.countryid,this.region_name,this.location_name,this.looking_for,this.property_type,this.region_name_real,this.propertytypename,this.lookingforname
  }) : super(key: key);
...
class _AdvaceSearchState extends State<SaveAdvanceSearch> {
  ...
  //   //print('"country${widget.countryid.toString()}plotfrom${sizetext}plotfrom${livingroomtext}${roomtext}${bedroomtext}${bathroomtext}${priceroomtext}${widget.propertytypename}');
